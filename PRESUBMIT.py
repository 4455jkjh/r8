...
from tools.utils import ensure_dep_from_google_cloud_storage
...
def CheckFormatting(input_api, output_api, branch):
    ...
    ensure_dep_from_google_cloud_storage(KOTLIN_FMT_JAR, KOTLIN_FMT_TGZ,
                                         KOTLIN_FMT_SHA1,
                                         'google-kotlin-format')
    ensure_dep_from_google_cloud_storage(FMT_CMD, FMT_TGZ, FMT_SHA1,
                                         'google-java-format')
    results = []
