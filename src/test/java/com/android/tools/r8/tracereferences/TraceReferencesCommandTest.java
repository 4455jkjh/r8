  ...
  public void testHelpMessage() {
    assertEquals(
        StringUtils.lines(
            ...
            "  --keep-rules            # Traced references will be output in the keep-rules"
                + " format.",
            ...
            "  --target <file>         # Add <file> as a target for tracing references. When target"
                + " is not specified",
            "                          # all references from source outside of library are treated"
                + " as a missing",
            "                          # references.",
            "  --output <file>         # Output result in <outfile>. If not passed the result will"
                + " go to standard",
            "                          # out.",
