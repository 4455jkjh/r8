...
public class RepackageResourcesWithHorizontalMergingTest extends TestBase {
  ...
  public void test() throws Exception {
    ...
    // Both A.txt and B.txt adapt to target class A's final name, causing a resource collision.
    String expectedAdaptedResourceName = aClassSubject.getFinalName().replace('.', '/') + ".txt";
