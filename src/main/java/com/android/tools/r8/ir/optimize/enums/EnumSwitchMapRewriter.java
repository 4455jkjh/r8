...
import static com.android.tools.r8.ir.optimize.enums.EnumValueOptimizer.getOrdinalValue;
...
public class EnumSwitchMapRewriter extends CodeRewriterPass<AppInfoWithLiveness> {

  public EnumSwitchMapRewriter(AppView<?> appView) {
    super(appView);
  }

  @Override
  protected String getRewriterId() {
    return "EnumSwitchMapRewriter";
  }

  @Override
  protected boolean shouldRewriteCode(IRCode code, MethodProcessor methodProcessor) {
    return options.enableEnumValueOptimization && appView.hasLiveness();
  }
  ...
  private Int2IntArrayMap computeOrdinalToTargetMap(
    ...
    for (int i = 0; i < switchInsn.numberOfKeys(); i++) {
      ...
      if (enumInstanceField == null) {
        ...
        SingleNumberValue ordinalValue = getOrdinalValue(code, abstractValue, true, appView);
