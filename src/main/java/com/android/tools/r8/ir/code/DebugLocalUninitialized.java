 ...
 *
 * <p>This instruction allows the local information to not necessarily be properly block structured.
 ...
 * does not exist in all predecessors (eg, for a local declared in an unscoped switch-case). By
 * emitting this "uninitialized" value in the method prelude, such a reference will instead become a
 * phi of the uninitialized value and the local.
 *
 * <p>This instruction may (and almost always will) be considered dead code and removed.
 */
