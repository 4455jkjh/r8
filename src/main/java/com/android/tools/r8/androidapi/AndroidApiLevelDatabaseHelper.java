...
public class AndroidApiLevelDatabaseHelper {
  ...
  public static void addUnsafeMethods(
    ...
    apiLevelConsumer.accept(factory.unsafeType, always);

    // Fields
    apiLevelConsumer.accept(
        factory.createField(factory.unsafeType, factory.intType, "INVALID_FIELD_OFFSET"),
        AndroidApiLevel.N);

    // Methods
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.intType), "addressSize"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.voidType), "fullFence"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.byteType, factory.longType), "getByte"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.charType, factory.longType), "getChar"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.intType, factory.longType), "getInt"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.longType, factory.longType), "getLong"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.unsafeType), "getUnsafe"),
        always);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.voidType), "loadFence"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
        ...
        always);
    apiLevelConsumer.accept(
        factory.createMethod(factory.unsafeType, factory.createProto(factory.intType), "pageSize"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
    ...
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType, factory.createProto(factory.voidType), "storeFence"),
        AndroidApiLevel.N);
    apiLevelConsumer.accept(
        factory.createMethod(
            factory.unsafeType,
