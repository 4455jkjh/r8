 ...
 *
 * <p>This should become a mostly drop-in replacement for uses of Proguard followed by dx for use
 * with the Android Platform build.
 *
 * <p>It accepts all Proguard flags supported by r8, except -outjars.
 *
 * <p>It accepts a few dx flags which are known to be used in the Android Platform build.
 *
 * <p>The flag -outjars does not make sense as r8 (like Proguard + dx) produces Dex output. For
 * output use --output as for R8 proper.
 */
